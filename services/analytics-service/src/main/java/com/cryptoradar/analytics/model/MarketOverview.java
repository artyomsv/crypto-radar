...
public class MarketOverview {
    ...
    public Integer getBullishCount() {
        return bullishCount;
    }

    public void setBullishCount(Integer bullishCount) {
        this.bullishCount = bullishCount;
    }

    public Integer getBearishCount() {
        return bearishCount;
    }

    public void setBearishCount(Integer bearishCount) {
    ...
    public List<MarketAnalysis> getAnalyses() {
        return analyses;
    }

    public void setAnalyses(List<MarketAnalysis> analyses) {
