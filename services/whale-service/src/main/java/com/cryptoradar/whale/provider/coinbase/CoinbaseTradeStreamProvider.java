...
public class CoinbaseTradeStreamProvider extends AbstractExchangeStreamProvider {
    ...
    protected String getSubscribeMessage() {
        return """
                {"type":"subscribe","channels":[{"name":"matches","product_ids":["BTC-USD","ETH-USD","XRP-USD","BNB-USD","SOL-USD","TRX-USD","DOGE-USD","BCH-USD","ADA-USD","LINK-USD","XMR-USD","XLM-USD","LTC-USD","ZEC-USD"]}]}""";
    }
